...
**** Localhost
     ...
     - run ~sbt assembly~
     - run ~java -cp main/target/scala-3.3.7/main.jar com.benkio.main.MainWebhook~
...
*** Deploy
 ...
 - Move the fat jar to the VM by ~rsync~ and ~ssh~. Eg. ~rsync -P -e "ssh -i <<private key of the vm>>" <<path to the fat jar -> sBots/main/target/scala-3.3.7/main.jar>> <<user of the vm>>@<<public IP of the vm>>:/home/<<user of the vm>>/main.jar~ (~rsync -P -e "ssh -i ubuntu_rsa.pem" /home/benkio/workspace/sBots/main/target/scala-3.3.7/main.jar ubuntu@129.152.27.196:/home/ubuntu/bots/main.jar~)
