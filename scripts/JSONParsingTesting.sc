...
val path = Paths.get("modules/botDB/ERR--1426863025-f2afb760-3d13-45d0-9e1c-ca52f186475110047902999000702394.json")

given log: LogWriter[IO] = consoleLogUpToLevel(LogLevels.Info)

ShowFetcher.filterAndParseJson[IO](path.toFile(), "testBot").unsafeRunSync()
